/**
 * Budget Performance Report API endpoint
 * GET /api/v2/reports/budget-performance?period=last-12-months
 * 
 * SIMPLIFIED: Core report endpoint for Budget Performance
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const performance = await coreService.getBudgetPerformance(userId, period);
    ...
    console.error("Error fetching budget performance report:", error);
