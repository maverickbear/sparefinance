-- Migration: Allow admins to read all users
-- This enables admin users to see all households/users in the system
-- Needed for account management where admins can assign accounts to any household
...
-- ============================================
-- Step 2: Drop existing policy if it exists (in case it was already created with recursion issue)
-- ============================================

DROP POLICY IF EXISTS "Admins can read all users" ON "User";

-- ============================================
-- Step 3: Add policy for admins to read all users
-- ============================================
