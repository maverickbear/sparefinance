...
export function DebtsDemo() {
  ...
  return (
    ...
    >
      {/* First Widget - Behind */}
      <div 
        className="absolute w-[85%] max-w-sm transform -rotate-3 z-10 transition-transform duration-100 ease-out"
        style={{
          transform: `translate(${20 + parallaxOffset * 0.3}px, ${20 - parallaxOffset * 0.2}px) rotate(-3deg)`,
      ...
      <div 
        ...
        style={{
          transform: `translate(${-20 - parallaxOffset * 0.4}px, ${-20 + parallaxOffset * 0.3}px) rotate(2deg)`,
          opacity: isVisible ? 1 : 0.3,
        }}
      >
        <Card className="transition-all">
