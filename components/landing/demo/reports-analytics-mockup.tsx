          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 bg-muted rounded-full h-3">
                <div className="bg-interactive-primary h-3 rounded-full" style={{ width: "65%" }} />
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 bg-muted rounded-full h-3">
                <div className="bg-sentiment-positive h-3 rounded-full" style={{ width: "25%" }} />
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 bg-muted rounded-full h-3">
                <div className="bg-interactive-primary h-3 rounded-full" style={{ width: "10%" }} />
              </div>
